...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    h_relu, cache_fc_relu = affine_relu_forward(X, W1, b1)
    scores, cache_score = affine_forward(h_relu, W2, b2)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    dh, dw2, db2 = affine_backward(dscores, cache_score)
    dx, dw1, db1 = affine_relu_backward(dh, cache_fc_relu)
  ...
  def loss(self, X, y=None):
    ...
    for i in xrange(self.num_layers):
        ...
        if i == self.num_layers-1:
            h_out, cache = affine_forward(h_in, w, b)
    ...
    for i in range(self.num_layers)[::-1]:
        dout = hidden['dh' + str(i+1)]
        cache = cache_h['h' + str(i+1)]
