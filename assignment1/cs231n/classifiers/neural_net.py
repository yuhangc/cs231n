...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    loss = np.sum(np.log(score_sum)) - np.sum(score_correct)
    ...
    #############################################################################
    dscores = score_exp / score_sum
    dscores[np.arange(num_train), y] -= 1.0
    dscores /= float(num_train)
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in xrange(num_iters):
      ...
      #########################################################################
      id_select = np.random.choice(num_train, batch_size, replace = True)
      X_batch = X[id_select, :]
      y_batch = y[id_select]
      #########################################################################
      #                             END OF YOUR CODE                          #
